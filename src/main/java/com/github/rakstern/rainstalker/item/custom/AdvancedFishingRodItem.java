...
public class AdvancedFishingRodItem extends FishingRodItem {
    public AdvancedFishingRodItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (user.fishHook != null) {
            ...
            if (world instanceof ServerWorld serverWorld) {
                ...
                FishingBobberEntity fishingBobberEntity = new FishingBobberEntity(user, world, k, j);
